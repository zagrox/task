                    ...
                    <form action="{{ route('tags.update', $tag->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="color" class="form-control form-control-color" id="color" name="color" value="{{ old('color', $tag->color) }}">
                                <input type="text" class="form-control" id="colorHex" value="{{ old('color', $tag->color) }}" onchange="document.getElementById('color').value = this.value">
                            </div>
